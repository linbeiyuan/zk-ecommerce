                    ...
                    },
                    {
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/shangpinguanlidetail/:id",
                                    name: "shangpinguanlidetail",
                                    meta: {
                                        title: "商品管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/shangpinguanli/detail.vue"),
                                },
                                {
                                    path: "/shangpinguanlilist",
                                    name: "shangpinguanlilist",
                                    meta: {
                                        title: "商品管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/shangpinguanli/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/shangpinfenleidetail/:id",
                                    name: "shangpinfenleidetail",
                                    meta: {
                                        title: "商品分类",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/shangpinfenlei/detail.vue"),
                                },
                                {
                                    ...
                                    component: () => import("@/views/shangpinfenlei/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/dianpuxinxidetail/:id",
                                    name: "dianpuxinxidetail",
                                    meta: {
                                        title: "店铺信息",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/dianpuxinxi/detail.vue"),
                                },
                                {
                                    path: "/dianpuxinxilist",
                                    name: "dianpuxinxilist",
                                    meta: {
                                        title: "店铺信息",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/dianpuxinxi/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/jifenshangdiandetail/:id",
                                    name: "jifenshangdiandetail",
                                    meta: {
                                        title: "积分商店",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/jifenshangdian/detail.vue"),
                                },
                                {
                                    path: "/jifenshangdianlist",
                                    name: "jifenshangdianlist",
                                    meta: {
                                        title: "积分商店",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/jifenshangdian/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/shangjiadetail/:id",
                                    name: "shangjiadetail",
                                    meta: {
                                        title: "商家",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/shangjia/detail.vue"),
                                },
                                {
                                    path: "/shangjialist",
                                    name: "shangjialist",
                                    ...
                                    component: () => import("@/views/shangjia/list.vue"),
                                },
