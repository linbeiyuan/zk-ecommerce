    ...
    <div class="detail-container">
      ...
      <div class="detail-content">
        ...
        <div class="detail-info-box">
              ...
              <h1 class="detail-title">{{ detail.mima }}</h1>
                                  
              <h1 class="detail-title">{{ detail.shoujihao }}</h1>
                                  
              <h1 class="detail-title">{{ detail.dizhi }}</h1>
                                                                            <!-- 产品属性 -->
          <div class="detail-attrs">
                ...
                <div class="detail-attr-item">
                  <span class="detail-attr-label">地址：</span>
                  <span class="detail-attr-value">{{detail.dizhi}}</span>
                </div>
                                                                                        </div>
