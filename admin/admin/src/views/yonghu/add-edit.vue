      ...
      if (state.type == 'cross') {
        ...
        for (var o in obj) {
                    ...
                    continue;
                                                              ...
                                                              if (o == 'dizhi') {
                    state.formData.dizhi = obj[o];
                    state.roisfalg.dizhi = true;
                    continue;
                  }
                                                              if (o == 'money') {
    ...
    <el-dialog :title="`${title}`" v-model="visible"
        ...
        <div v-loading="loadding">
            ...
            >
                        ...
                        <el-form-item label="地址" prop="dizhi" :rules="{required: true, message: '地址为必填项！', trigger: 'blur'}">
                            <el-input v-model="formData.dizhi" maxlength="30" clearable show-word-limit placeholder="请输入地址" :readonly="roisfalg.dizhi"/>
                        </el-form-item>
