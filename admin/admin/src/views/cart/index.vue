        ...
        <div class="layout-padding">
            <el-form inline :model="query" label-suffix=":">
                  ...
                  <div class="button-container">
                    ...
                    <el-button  class="button button-6" v-if="isAuth('cart','删除')" icon="ele-Delete" @click="listdel()" :disabled="isdel" type="danger">多选删除</el-button>
                    <el-button class="button button-8" v-if="isAuth('cart','新增')" icon="ele-Plus" type="success" @click="add()">新增</el-button>
                                                                                                          </div>
            ...
            color: '#ffffff'
                ...
                <el-table-column type="selection" width="55" />
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="tablename" label="商品表名">
                                    ...
                                    <template #default="{row}">
                                        {{row.userid}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="goodid" label="商品id">
                                    ...
                                    <template #default="{row}">
                                        {{row.goodname}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="picture" label="图片">
                                    ...
                                    <template #default="{row}">
                                        {{row.buynumber}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="price" label="单价">
                                    ...
                                    <template #default="{row}">
                                        {{row.price}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="discountprice" label="会员价">
                    ...
                    <template #default="{row}">
                                                                        <el-button class="button button-8" v-if="isAuth('cart','修改')" icon="ele-Edit" @click.stop="handleEdit(row)" type="warning">修改</el-button>
                        <el-popconfirm  v-if="isAuth('cart','删除')"  width="auto" @confirm="handleDelete(row)"  :title="`确定永久删除吗？`">
                            <template #reference>
